...
namespace
{
    ...
    // === LEGACY PATCH BEGIN === (ES-style media-path keys for ROM-folder gamelist.xml)
    {"image",              MD_PATH,             "",                false,     "IMAGE",                       "ENTER PATH TO IMAGE",              true},
    {"thumbnail",          MD_PATH,             "",                false,     "THUMBNAIL",                   "ENTER PATH TO THUMBNAIL",          true},
    {"marquee",            MD_PATH,             "",                false,     "MARQUEE",                     "ENTER PATH TO MARQUEE",            true},
    {"video",              MD_PATH,             "",                false,     "VIDEO",                       "ENTER PATH TO VIDEO",              true},
