...
| gamegear              | Sega Game Gear                                 | Genesis Plus GX                   | Genesis Plus GX Wide,<br>Gearsystem,<br>SMS Plus GX,<br>PicoDrive,<br>BlastEm,<br>Mednafen **(Standalone)**,<br>Mesen **(Standalone)** [LW],<br>MesenCE,<br>ares **(Standalone)**,<br>jgenesis **(Standalone)** [LW],<br>Emulicious **(Standalone)** [LW] | No           | Single archive or ROM file |
...
| mark3                 | Sega Mark III                                  | Genesis Plus GX                   | Genesis Plus GX Wide,<br>SMS Plus GX,<br>Gearsystem,<br>PicoDrive,<br>BlastEm,<br>Mednafen **(Standalone)**,<br>Mesen **(Standalone)** [LW],<br>MesenCE,<br>ares **(Standalone)**,<br>jgenesis **(Standalone)** [LW],<br>Emulicious **(Standalone)** [LW] | No           | Single archive or ROM file |
| mastersystem          | Sega Master System                             | Genesis Plus GX                   | Genesis Plus GX Wide,<br>SMS Plus GX,<br>Gearsystem,<br>PicoDrive,<br>BlastEm,<br>Mednafen **(Standalone)**,<br>Mesen **(Standalone)** [LW],<br>MesenCE,<br>ares **(Standalone)**,<br>jgenesis **(Standalone)** [LW],<br>Emulicious **(Standalone)** [LW] | No           | Single archive or ROM file |
